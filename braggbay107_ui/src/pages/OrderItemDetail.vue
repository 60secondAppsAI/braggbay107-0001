						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div id="app">
								  ...
								  <base-input label="ItemPrice" type="text" placeholder="Enter ItemPrice" v-model="orderItemToAdd.itemPrice"></base-input>
												                  </form>
								                </div>
            ...
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Item Price</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="ItemPrice" type="text" placeholder="Enter ItemPrice" v-model="orderItemDetails.itemPrice"></input>
																		</div>
						</td>
														</tr>
